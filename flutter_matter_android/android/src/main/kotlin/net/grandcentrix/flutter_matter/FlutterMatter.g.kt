            ...
            run {
                ...
                if (api != null) {
                    channel.setMessageHandler { message, reply ->
                        ...
                        api.openPairingWindowWithPin(
                            deviceIdArg,
                            durationArg,
                            discriminatorArg,
                            setupPinArg,
                        ) { result: Result<OpenPairingWindowResult> ->
                            val error = result.exceptionOrNull()
                            if (error != null) {
                                reply.reply(wrapError(error))
                            } else {
...
interface FlutterMatterHostOnOffClusterApi {
    ...
    fun subscribeToOnOff(
        deviceId: Long,
        endpointId: Long,
        callback: (Result<Unit>) -> Unit,
    )

    fun unsubscribeToOnOff(
        deviceId: Long,
        endpointId: Long,
        callback: (Result<Unit>) -> Unit,
    )
    ...
    companion object {
        ...
        fun setUp(
            binaryMessenger: BinaryMessenger,
            api: FlutterMatterHostOnOffClusterApi?,
        ) {
            run {
                val channel =
                    BasicMessageChannel<Any?>(
...
interface FlutterMatterHostDescriptorClusterApi {
    ...
    companion object {
        ...
        fun setUp(
            binaryMessenger: BinaryMessenger,
            api: FlutterMatterHostDescriptorClusterApi?,
        ) {
            run {
                val channel =
                    BasicMessageChannel<Any?>(
...
interface FlutterMatterHostTemperatureClusterApi {
    ...
    fun readMinMeasuredValue(
        deviceId: Long,
        endpointId: Long,
        callback: (Result<Long?>) -> Unit,
    )

    fun readMaxMeasuredValue(
        deviceId: Long,
        endpointId: Long,
        callback: (Result<Long?>) -> Unit,
    )
    ...
    companion object {
        ...
        fun setUp(
            binaryMessenger: BinaryMessenger,
            api: FlutterMatterHostTemperatureClusterApi?,
        ) {
            run {
                val channel =
                    BasicMessageChannel<Any?>(
