...
import net.grandcentrix.flutter_matter.FlutterMatterHostTemperatureClusterApi
...
class TemperatureCluster: FlutterMatterHostTemperatureClusterApi, Closeable {
    ...
    private suspend fun getCluster(deviceId: Long, endpointId: Long): ChipClusters.TemperatureMeasurementCluster {
    ...
    override fun readMeasuredValue(
        ...
        scope.launch {
            ...
            cluster?.readMeasuredValueAttribute(object :
    ...
    override fun readMinMeasuredValue(
        ...
        scope.launch {
            ...
            cluster?.readMinMeasuredValueAttribute(object :
    ...
    override fun readMaxMeasuredValue(
        ...
        scope.launch {
            ...
            cluster?.readMaxMeasuredValueAttribute(object :
    ...
    override fun readTolerance(
        ...
        scope.launch {
            ...
            cluster?.readToleranceAttribute(object :
