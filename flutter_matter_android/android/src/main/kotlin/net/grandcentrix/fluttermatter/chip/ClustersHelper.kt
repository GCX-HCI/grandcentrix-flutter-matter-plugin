...
class ClustersHelper
    @Inject
    constructor(private val chipClient: ChipClient) {
        // -----------------------------------------------------------------------------------------------
        ...
        suspend fun readBasicClusterVendorIDAttribute(
            deviceId: Long,
            endpoint: Int,
        ): Int? {
            val connectedDevicePtr =
         ...
         */
        suspend fun writeBasicClusterNodeLabelAttribute(
            deviceId: Long,
            nodeLabel: String,
        ) {
            val connectedDevicePtr =
        ...
        suspend fun toggleDeviceStateOnOffCluster(
            deviceId: Long,
            endpoint: Int,
        ) {
        ...
        suspend fun getDeviceStateOnOffCluster(
            deviceId: Long,
            endpoint: Int,
        ): Boolean? {
