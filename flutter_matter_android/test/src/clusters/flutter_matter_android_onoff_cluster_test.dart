...
import 'flutter_matter_android_onoff_cluster_test.mocks.dart';

@GenerateNiceMocks([
  MockSpec<FlutterMatterHostOnOffClusterApi>(),
])
void main() {
  late FlutterMatterAndroidOnOffCluster sut;
  ...
  setUp(() {
    ...
    sut = FlutterMatterAndroidOnOffCluster(
  ...
  group('FlutterMatterFlutterOnOffClusterApi', () {
    group('onOff', () {
      ...
      test(
        ...
        sut.onOff(123, 1, true, AndroidError(code: '-1', message: 'bad error'));
